...
function App() {
  ...
  return (
    <body className='bg-purple-800 flex flex-col items-center min-h-dvh'>
      ...
      <div className='my-4 hidden'>
        ...
        <form className={`mt-8 rounded-lg flex flex-col items-center ${showForm ? '' : 'hidden'}`} action="">
          ...
          <button className='mt-4 bg-blue-800 p-3 rounded-2xl text-white font-semibold text-lg border-2 drop-shadow-lg border-color-white' onClick={handleSubmit}>Submit</button>
        </form>
      </div>
      <div className={`flex flex-col items-center sm:h-80 sm:w-96 ${show ? 'h-80 w-80':'hidden'}`}>
